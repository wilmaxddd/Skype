...
public class RegisterForm extends JDialog {
	...
	public RegisterForm(JFrame parent, Runnable callback) {
		super(parent, "Skype\u2122 - Create Account", true);
		...
		JLabel titleLabel = new JLabel("Create a new Skype account.");
...

		{
			...
			JLabel label = new JLabel("Create Skype Name");
				...
				public void focusLost(FocusEvent arg0) {
					if (createSkypeNameTextField.getText().equals("")) {
						createSkypeNameTextField
								.setText("3-32 characters needed");
					}
				}
		...
		primaryButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				callback.fullName = fullNameTextField.getText();
				callback.skypeName = createSkypeNameTextField.getText();
	...
	public static abstract class Runnable implements java.lang.Runnable {
		...
		public String fullName, skypeName, password;
