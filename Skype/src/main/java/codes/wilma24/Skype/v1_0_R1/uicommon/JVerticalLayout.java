...
public class JVerticalLayout implements LayoutManager {
	 ...
	 *            components
	 */
	public JVerticalLayout(int vgap) {
	 ...
	 *            alignment.
	 */
	public JVerticalLayout(int vgap, int alignment) {
	 ...
	 */
	public JVerticalLayout(int vgap, int alignment, int anchor) {
		this.vgap = vgap;
