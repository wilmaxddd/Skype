...
public abstract class TaskbarProgressbar {
     ...
     */
    public void showCustomProgress(double progress, Type type) {
     ...
     * @throws NullPointerException if type is null
     */
    public abstract void setProgressType(Type type);
    ...
    private synchronized static TaskbarProgressbarImpl getTaskbarProgressbarImpl(Stage stage) {
     ...
     * @throws NullPointerException if the stage or the type is null
     */
    public static void showCustomProgress(Stage stage, double progress, Type type) {
     ...
     * @throws NullPointerException if type is null
     */
    public static void setProgressType(Stage stage, Type type) {
