...
public class UpdateVoipContactsCmd extends CommandExecutor {

	@Override
	public PacketPlayInReply onCommand(SocketHandlerContext ctx, Object msg) {
		PacketPlayOutUpdateVoipContacts packet = Packet.fromJson(
				msg.toString(), PacketPlayOutUpdateVoipContacts.class);
		...
		if (!Skype.getPlugin().getConversationManager()
				.updateVoipContacts(conversationId, payload)) {
			PacketPlayInReply replyPacket = new PacketPlayInReply(
					packet.getType(), PacketPlayInReply.BAD_REQUEST, packet
							.getType().name() + " failed");
			return replyPacket;
